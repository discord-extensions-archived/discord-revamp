...
## Issue Reporting
If you notice any coloring issues with the theme (such as something missing color), please report it to the [Theme Source](https://github.com/LuckFire/theme-source) repo, as this mainly uses that to theme the base colors. If you notice any other type of issue, please report it **on this repo**.

## Looking for Dark Discord?
You may instead be looking for Dark Discord, which you can find **[here](https://github.com/snappercord/dark-discord)**.